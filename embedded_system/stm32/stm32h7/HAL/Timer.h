...
#define Timer_CC_DMA_Enable(x,y)        (x)->TIMx->DIER|=1<<(y+9)

#define Timer_CC_DMA_Disable(x,y)        (x)->TIMx->DIER|=~(1<<(y+9))

#define Timer_UDE_DMA_Enable(x)        (x)->TIMx->DIER|=1<<8

#define Timer_UDE_DMA_Disable(x)        (x)->TIMx->DIER|=~(1<<8)

//PWM输出使能，x：定时器；y：输出通道
#define Timer_PWMOutput_Enable(x,y) 	(x)->TIMx->CCER|=1<<(y*4)
//PWM输出失能，x：定时器；y：输出通道
#define Timer_PWMOutput_Disable(x,y) 	(x)->TIMx->CCER&=~(1<<(y*4))
...
//void Timer_EncoderMode_Set(Timer_Info* Timer, 
